...
import { ArrowLeft, User, Mail, Building2, Calendar, CheckCircle2, XCircle, Upload, FileText, FileSpreadsheet, Clock, XOctagon } from 'lucide-react'
...
import { ManagementTab } from '@/components/seller-management/management-tab'
...
export default function PartnerDetailPage({ params }: PartnerDetailPageProps) {
  ...
  const [currentSeller, setCurrentSeller] = useState<Seller | undefined>(
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="management" className="mt-0">
            <ManagementTab seller={seller} onSellerUpdate={setCurrentSeller} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
